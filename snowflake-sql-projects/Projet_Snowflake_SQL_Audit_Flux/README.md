...
|---|---|---|
| 1 | [`01_SNOWFLAKE_LOAD_AND_MART.sql`](sql/01_SNOWFLAKE_LOAD_AND_MART) | Pipeline SQL end-to-end chargeant les 9 sources, créant les couches RAW et MART, calculant les KPIs métier et exposant une vue BI consolidée. |
...
[`Specification_SQL_Script_Pipeline`](docs) - spécification technique détaillée du pipeline SQL : architecture, étapes de traitement, tables créées, logique de calcul, contrôles qualité, scoring de risque et hypothèses métier.
