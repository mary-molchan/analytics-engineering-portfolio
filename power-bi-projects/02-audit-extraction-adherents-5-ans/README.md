...
- [**Spécification fonctionnelle Power BI**](docs/Sp%C3%A9cification_fonctionnelle_dashboard_Power_BI.md) - description du besoin métier, des utilisateurs, des pages, des filtres, des visualisations, des règles de gestion et des critères d’acceptation.

- [**Spécification technique Power BI**](docs/Sp%C3%A9cification_technique_dashboard_Power_BI.md) - description des sources, du modèle sémantique, des transformations, des mesures DAX, du refresh, de la sécurité et des contrôles techniques.
